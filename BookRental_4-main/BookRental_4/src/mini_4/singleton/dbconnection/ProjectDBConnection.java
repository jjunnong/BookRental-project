package mini_4.singleton.dbconnection;
...
public class ProjectDBConnection {
	...
	static {
		...
		try {
			 ...
			 conn = DriverManager.getConnection("jdbc:oracle:thin:@211.238.142.77:1521:xe", "SEMIUSER_4", "cclass");
	           // jdbc:oracle:thin:@ip:포트넘버:xe, 오라클사용자 아이디,오라클비밀번호
